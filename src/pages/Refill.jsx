...
import { ArrowRight, Clock, Shield, CheckCircle, Phone, FileText, Calendar, Pill } from 'lucide-react'
...
function Refill() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    alert('Thank you! Your prescription refill request has been submitted. We will process your refill and notify you when it is ready.')
    setFormData({
      firstName: '',
      lastName: '',
      dateOfBirth: '',
  ...
  return (
    <div>
      ...
      {/* Refill Form Section - Moved to Top */}
          ...
          <Card className="bg-white border-gray-200 shadow-lg">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white text-lg py-4 font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200" disabled={!formData.agreeToTerms}>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600">
              For more information about our legal policies, please contact our compliance officer at <a href="mailto:compliance@quickrxpharmacy.com" className="text-green-600 hover:underline">compliance@quickrxpharmacy.com</a>
            </p>
          </div>
        </div>
      </section>
